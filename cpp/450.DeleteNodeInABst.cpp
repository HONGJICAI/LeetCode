 ...
 */
class Solution {
//Runtime: 32 ms, faster than 87.87% of C++ online submissions for Delete Node in a BST.
//Memory Usage: 12.8 MB, less than 69.11% of C++ online submissions for Delete Node in a BST.
public:
