class LFUCache {
//Runtime: 108 ms, faster than 97.00% of C++ online submissions for LFU Cache.
//Memory Usage: 40.3 MB, less than 75.85% of C++ online submissions for LFU Cache.
    int cap;
    int minFreq;
