class Solution {
//Runtime: 20 ms, faster than 98.91% of C++ online submissions for Substring with Concatenation of All Words.
//Memory Usage: 10.8 MB, less than 99.11% of C++ online submissions for Substring with Concatenation of All Words.
public:
