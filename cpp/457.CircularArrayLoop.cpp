class Solution {
//Runtime: 4 ms, faster than 88.75% of C++ online submissions for Circular Array Loop.
//Memory Usage: 8.4 MB, less than 75.74% of C++ online submissions for Circular Array Loop.
public:
